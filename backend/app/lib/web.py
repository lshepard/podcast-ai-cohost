...
async def scrape_webpage(url: str) -> Tuple[bool, str, Optional[str], Optional[str], Optional[str]]:
    ...
    try:
        if is_pdf_url(url):
            # For PDFs, use the PDF processing module
        ...
        async with AsyncWebCrawler(config=browser_config) as crawler:
            ...
            # Log the first 200 characters of the markdown for debugging
            logger.info(f"First 200 chars of markdown: {crawl_result.markdown[:200]}")
